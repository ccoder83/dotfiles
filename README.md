...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ccoder83/dotfiles/wsl/configure.sh)"
```
### WSL Emulator Install
Run the following command from an Administrator PowerShell prompt...
```
Set-ExecutionPolicy Bypass; irm 'https://raw.githubusercontent.com/ccoder83/dotfiles/wsl/wslterm.ps1' | iex;
```
